    ...
    <div class="p-5">
        <div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-3xl font-bold text-gray-800">Editar Rascunho</h1>
                <a href="{{ route('drafts.show', $draft) }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg font-bold hover:bg-blue-700 transition-colors">
                    Visualizar
                </a>
            </div>
            ...
            <form action="{{ route('drafts.update', $draft) }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <textarea id="content" name="content" rows="15"
                        ...
                        placeholder="Escreva aqui o conteúdo do seu pattern...">{{ old('content', $draft->content) }}</textarea>
                    @error('content')
                        <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                    @enderror
                </div>
