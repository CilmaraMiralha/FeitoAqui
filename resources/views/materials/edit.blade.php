...
<head>
    ...
    <title>Editar Material - {{ $material->name }} - FeitoAqui</title>
    ...
    <section class="py-20 flex-grow">
        <div class="max-w-3xl mx-auto px-6 sm:px-8 lg:px-12">
            <div class="mb-8">
                ...
                <h1 class="text-3xl lg:text-4xl font-serif font-bold text-[var(--coffee)] mb-3">Editar Material</h1>
                <p class="text-slate-500 font-light leading-relaxed">Atualize as informações do material.</p>
            </div>
                ...
                <form action="{{ route('materials.update', $material) }}" method="POST">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="text-slate-500 text-sm mt-2 leading-relaxed">
                            Peso padrão da embalagem (opcional)
                        </div>
                        @error('fixed_weight')
                            <div class="text-red-600 text-sm mt-2">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="bg-yellow-50 border-l-4 border-yellow-400 p-6 rounded-lg mb-8">
                        <div class="flex items-start">
                            ...
                            <p class="text-sm text-yellow-700 leading-relaxed">
                                <strong>Atenção:</strong> As variações (cores, quantidades) devem ser editadas na página de detalhes do material.
                            </p>
                        </div>
                    </div>
