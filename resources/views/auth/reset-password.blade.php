...
<body class="bg-gradient-to-br from-[#B2675E] to-[#644536] min-h-screen">
    ...
    <div class="flex items-center justify-center p-5 min-h-[calc(100vh-64px)]">
        ...
        <h1 class="text-3xl font-bold text-gray-800 mb-8 text-center">Redefinir Senha</h1>
        ...
        <form action="{{ route('password.update') }}" method="POST">
            ...
            <div class="mb-5">
                <label for="password" class="block mb-2 text-gray-700 font-bold">Nova Senha</label>
            ...
            <div class="mb-5">
                <label for="password_confirmation" class="block mb-2 text-gray-700 font-bold">Confirmar Nova Senha</label>
                <input type="password" id="password_confirmation" name="password_confirmation"
                    class="w-full px-3 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-[#B2675E] transition-colors"
                    required>
            </div>

            <button type="submit" class="w-full py-3 bg-[#B2675E] text-white rounded-lg font-bold hover:bg-[#644536] transition-colors mt-3">
                Redefinir Senha
            </button>
        </form>
    </div>
